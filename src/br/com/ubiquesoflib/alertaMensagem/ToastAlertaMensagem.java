 ...
 *
 */
public class ToastAlertaMensagem {
	 ...
	 */
	public ToastAlertaMensagem(Activity context) {
		mContext = context;
	}
    
	/**
	 * Make a {@link ToastAlertaMensagem} that just contains a text view.
	 * 
	 * @param context
	 *            The context to use. Usually your
	 *            {@link android.app.Activity} object.
	 ...
	 * 
	 */
    public static ToastAlertaMensagem makeText(Activity context, CharSequence text, Style style) {
    	ToastAlertaMensagem result = new ToastAlertaMensagem(context);

        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(R.layout.alerta_msg, null);
	...
	/**
	 * Make a {@link ToastAlertaMensagem} that just contains a text view with the text from a
	 * resource.
	 * 
	 * @param context
	 *            The context to use. Usually your
	 ...
	 */
	public static ToastAlertaMensagem makeText(Activity context, int resId, Style style)
			throws Resources.NotFoundException {
     ...
     */
    public void show() {
    	ToastAlertaMensagemManager manager = ToastAlertaMensagemManager.getInstance();
        manager.add(this);
    }
    
    /**
     * @return <code>true</code> if the {@link ToastAlertaMensagem} is being displayed, else <code>false</code>.
     */
    boolean isShowing() {
     ...
     */
    public void cancel() {
    	ToastAlertaMensagemManager.getInstance().clearMsg(this);
    }
    
    /**
	 * Cancels all queued {@link ToastAlertaMensagem}s. If there is a {@link ToastAlertaMensagem}
	 * displayed currently, it will be the last one displayed.
	 */
	public static void cancelAll() {
		ToastAlertaMensagemManager.getInstance().clearAllMsg();
	}
     ...
     */
    public ToastAlertaMensagem setLayoutParams(LayoutParams layoutParams) {
    ...
    public static class Style {
		...
		/**
		 * Construct an {@link ToastAlertaMensagem.Style} object.
		 * 
		 * @param duration
		...
		public boolean equals(Object o) {
			if (!(o instanceof ToastAlertaMensagem.Style)) {
				return false;
			}
			Style style = (Style) o;
